...
http://localhost:9000/conao3-helper/us-central1/github_header/firebase-helper
#+begin_src bash
...
http://localhost:9000/conao3-helper/us-central1/github_header/:header
- ~:header~ is string
...
ex: http://localhost:9000/conao3-helper/us-central1/github_header/conao3%2Ffirebase-helper?forground=000&background=abc
